...
const stats = [
  { label: "Dispositivos Conectados", value: "5", icon: Smartphone, trend: "+2 hoje" },
  { label: "Enviadas Hoje", value: "1.247", icon: Send, trend: "+18%" },
  { label: "Enviadas no Mês", value: "32.580", icon: TrendingUp, trend: "+12%" },
  { label: "Taxa de Entrega", value: "98.2%", icon: CheckCircle, trend: "Estável" },
];

const hourlyData = [
  { hora: "08h", enviadas: 45 },
  { hora: "09h", enviadas: 120 },
  { hora: "10h", enviadas: 230 },
  { hora: "11h", enviadas: 180 },
  { hora: "12h", enviadas: 90 },
  { hora: "13h", enviadas: 60 },
  { hora: "14h", enviadas: 200 },
  { hora: "15h", enviadas: 280 },
  { hora: "16h", enviadas: 210 },
  { hora: "17h", enviadas: 150 },
  { hora: "18h", enviadas: 80 },
];
...
const sessions = [
  ...
  { name: "Chip 04 – Financeiro", status: "Loading", number: "+55 31 9****-3456" },
  { name: "Chip 05 – Backup", status: "Ready", number: "+55 41 9****-7890" },
];
  ...
  <div className="space-y-6 animate-fade-up">
    ...
    <Card className="glass-card border-yellow-500/30">
      <CardContent className="p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-foreground">Alerta de Desconexão</p>
          <p className="text-xs text-muted-foreground mt-0.5">
            O dispositivo <span className="font-medium">Chip 03 – Marketing</span> perdeu a conexão às 14:32. Reconecte para continuar os disparos.
          </p>
        </div>
      </CardContent>
    </Card>

          ...
          <div className="space-y-5 py-2">
            ...
            <div className="rounded-xl border border-border/20 bg-muted/10 p-4 space-y-3">
              ...
              <div className="space-y-1 text-[11px]">
                <p className="text-foreground">• Início: {planSummary.volumeStart[0]}–{planSummary.volumeStart[1]}/dia</p>
                <p className="text-foreground">• Final: {planSummary.volumeEnd[0]}–{planSummary.volumeEnd[1]}/dia</p>
                <p className="text-foreground">• Pico: {planSummary.peakMax[0]}–{planSummary.peakMax[1]}/dia</p>
                <p className="text-foreground">• Total estimado: ~{planSummary.totalEstimated} ações</p>
              </div>

              <div className="space-y-1 text-[11px]">
                <p className="text-muted-foreground font-medium">Proteções:</p>

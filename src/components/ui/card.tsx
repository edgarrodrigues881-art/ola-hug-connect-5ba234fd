...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-xl sm:rounded-[14px] border border-border/40 bg-card text-card-foreground shadow-sm dark:shadow-[0_6px_24px_rgba(0,0,0,0.35)] dark:border-border/30 transition-[border-color,background-color,box-shadow] duration-150 ease-out hover:border-border/60 hover:bg-card/90 dark:hover:bg-card/80", className)} {...props} />
));

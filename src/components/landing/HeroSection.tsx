    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      <div className="container relative z-10 py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          {/* Left — Copy: single motion wrapper instead of 3 separate */}
          <motion.div
          ...
          {/* Right — Phone: single motion wrapper for all */}
          <motion.div
          ...
          >
            ...
            <div className="relative" style={{ perspective: "900px" }}>
              ...
              >
                {/* Outer glow — static radial-gradient */}
                <div
            ...
            {/* Floating notification bubbles — NO individual motion wrappers, static */}
            <div className="hidden lg:block">
              ...
              <div className="absolute right-[-60px] top-[8%] w-[210px]">
                <div className="relative rounded-2xl p-4 overflow-hidden"
                  style={{
                    ...
                    boxShadow: "0 4px 12px -4px rgba(0,0,0,0.3), 0 0 0 1px rgba(7,193,96,0.15)",
                  }}
                >
              ...
              <div className="absolute left-[-55px] top-[25%]">
                <div className="relative rounded-2xl p-4 overflow-hidden"
                  style={{
                    background: "linear-gradient(145deg, rgba(17,24,39,0.98), rgba(10,15,25,0.96))",
                    boxShadow: "0 4px 12px -4px rgba(0,0,0,0.3), 0 0 0 1px rgba(7,193,96,0.12)",
                  }}
                >
              ...
              <div className="absolute left-[-30px] bottom-[12%]">
                <div className="relative rounded-xl px-3.5 py-2.5 flex items-center gap-2.5 overflow-hidden"
                  style={{
                    background: "linear-gradient(145deg, rgba(17,24,39,0.98), rgba(10,15,25,0.96))",
                    boxShadow: "0 4px 12px -4px rgba(0,0,0,0.3), 0 0 0 1px rgba(7,193,96,0.1)",
                  }}
                >

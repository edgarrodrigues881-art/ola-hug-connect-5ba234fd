    ...
    <div className="fixed bottom-6 right-6 md:bottom-6 md:right-6 bottom-[env(safe-area-inset-bottom,24px)] right-4 z-50 flex flex-col items-end gap-3">
      {open && (
        <a
          ...
          className="flex items-center gap-3 bg-secondary border border-border rounded-lg px-4 py-3 text-sm font-medium text-foreground hover:bg-accent transition-colors whitespace-nowrap shadow-lg animate-fade-up"
        >

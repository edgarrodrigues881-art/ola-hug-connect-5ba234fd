    ...
    <div className="space-y-4">
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input placeholder="Buscar telefone, nome, email..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9 bg-card border-border text-sm h-9" />
        </div>
        <Select value={filterStatus} onValueChange={setFilterStatus}>
          <SelectTrigger className="w-[140px] h-9 bg-card border-border text-xs"><SelectValue placeholder="Status" /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={filterEnrolled} onValueChange={setFilterEnrolled}>
          <SelectTrigger className="w-[130px] h-9 bg-card border-border text-xs"><SelectValue placeholder="Enrolled" /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={filterPhase} onValueChange={setFilterPhase}>
          <SelectTrigger className="w-[160px] h-9 bg-card border-border text-xs"><SelectValue placeholder="Phase" /></SelectTrigger>
          <SelectContent>
      ...
      <p className="text-xs text-muted-foreground">{filtered.length} instância(s)</p>

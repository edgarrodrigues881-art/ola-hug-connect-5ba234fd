                  ...
                  <div key={inst.id} className="flex items-center gap-3 px-6 py-3 text-sm">
                    ...
                    {inst.status === "CONECTADA" && (
                      <>
                        ...
                        <Button size="sm" variant="outline" onClick={() => setBulkModal({ clientId: c.id, instanceId: inst.id, name: inst.name })} className="h-7 text-xs border-zinc-600 text-blue-300">
